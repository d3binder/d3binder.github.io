...
(function () {
  ...
  function mergedNotifications() {
    ...
    var all = admin.concat(notificationsCache.system || []);
  ...
  function renderNotificationsList() {
    ...
    host.innerHTML = items.map(function (n) {
      ...
      return '<div class="fn-notification-item">' +
        '<div class="fn-notification-item-title">' + escapeHtml(n.title || "") + "</div>" +
        (n.body ? '<div class="fn-notification-item-body">' + escapeHtml(n.body) + "</div>" : "") +
        '<div class="fn-notification-item-meta"><span class="fn-notification-item-date">' + formatNotifDate(n.date) + "</span>" + linkHtml + "</div>" +
      "</div>";
    }).join("");
  }
      ...
      .then(function (json) {
        notificationsCache.admin = (Array.isArray(json) ? json : []).map(function (n) {
          return {
            ...
            label: n.label || "", expires: n.expires || null
          };
        });
        updateNotificationsBadge();
