...
(function () {
  ...
  function setProfile(patch) {
    ...
    // every call here is a write to the live profile, so this is the one
    // choke point to stamp when it last actually changed — read by nav.js's
    // "Last saved" indicator in the "Your info" panel
