...
(function () {
  ...
  var PAGES = [
    ...
    { id: "fi-snapshot", label: "FI Snapshot", href: BASE + "FISnapshot/index.html", group: "The Basics" },
    { id: "net-worth", label: "Net Worth", href: BASE + "NetWorth/index.html", group: "The Basics" },
    { id: "budget-calculator", label: "Budget Calculator", href: BASE + "BudgetCalculator/index.html", group: "The Basics" },
    { id: "emergency-fund", label: "Emergency Fund", href: BASE + "EmergencyFund/index.html", group: "The Basics" },
    { id: "debt-snowball", label: "Debt Snowball", href: BASE + "DebtSnowball/index.html", group: "The Basics" },

    { id: "time-to-fi", label: "Time to FI", href: BASE + "TimeToFI/index.html", group: "Financial Independence" },
    { id: "reverse-time-to-fi", label: "Reverse Time to FI", href: BASE + "ReverseTimeToFI/index.html", group: "Financial Independence" },
    { id: "fire-milestones", label: "FIRE Milestones", href: BASE + "FireMilestones/index.html", group: "Financial Independence" },
    { id: "coast-fire", label: "Coast & Barista FIRE", href: BASE + "CoastFire/index.html", group: "Financial Independence" },
    { id: "crossover-point", label: "Crossover Point", href: BASE + "CrossoverPoint/index.html", group: "Financial Independence" },
    { id: "compound-interest", label: "Compound Interest", href: BASE + "CompoundInterest-WealthMultiplier/index.html", group: "Financial Independence" },
    ...
    { id: "cash-out-or-hold", label: "Cash Out or Hold", href: BASE + "CashOutOrHold/index.html", group: "Everyday Money Decisions" },
    ...
    var profilePanel =
      '<div class="fn-profile-panel" role="menu" aria-label="Your info">' +
        '<div class="fn-settings-title-row">' +
          ...
          "</div>" +
        "</div>" +
        '<div class="fn-profile-actions-row">' +
          ...
          '<div class="fn-quickload" id="fnQuickload">' +
            ...
            "</div>" +
          "</div>" +
          '<span class="fn-settings-actions-divider" aria-hidden="true"></span>' +
